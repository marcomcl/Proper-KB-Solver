...
public class Implicative implements Formula {
    ...
    public Set<Term> standardNames() {
        Set<Term> stdNames = premise.standardNames();
        stdNames.addAll(conclusion.standardNames());
    ...
    public Set<Term> nulls() {
        Set<Term> nulls = premise.nulls();
        nulls.addAll(conclusion.nulls());
    ...
    public Set<Term> constants() {
        Set<Term> constants = premise.constants();
        constants.addAll(conclusion.constants());
